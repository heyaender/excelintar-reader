...
use heyaender\ExcelintarReader\Interfaces\InterfaceBookReader;
use heyaender\ExcelintarReader\Interfaces\InterfaceSheetReader;
use heyaender\ExcelintarReader\Interfaces\InterfaceXmlReader;
    ...
    public function readCallback(callable $callback, $columnKeys = [], int $resultMode = null, ?bool $styleIdxInclude = null)
    {
        foreach ($this->nextRow($columnKeys, $resultMode, $styleIdxInclude) as $row => $rowData) {
            ...
            foreach ($rowData as $col => $val) {
                if (
                    isset($this->area['col_keys']) && array_key_exists($col, $this->area['col_keys'])
